...
import { ShoppingBag, Clock, CheckCircle, AlertCircle, TrendingUp, TrendingDown, Calendar, Filter } from 'lucide-react';
...
const ModernDashboard = ({ comandas, ganancias }) => {
  ...
  const filteredOrdersComandas = useMemo(() => 
    filterDataByTimeRange(comandas, orderTimeRange === 'day' ? '24h' : orderTimeRange === 'week' ? '7d' : 'all'),
...
return (
    <div className="min-h-screen p-4 md:p-8">
      ...
      <div className="md:col-span-2 lg:col-span-3">
        ...
        <div className="bg-[#e4f4ff] rounded-xl border border-gray-100 shadow-sm p-4 md:p-6 flex flex-col">
      ...
      <div className="md:col-span-2 lg:col-span-4 flex flex-col">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 flex-grow">
          {[
            ...
            <div key={index} className={`${card.bg} rounded-xl border border-gray-100 shadow-sm p-3 md:p-4 flex flex-col justify-between`}>
